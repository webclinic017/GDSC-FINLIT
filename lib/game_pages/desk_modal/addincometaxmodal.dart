...
class AddIncomeTaxModal extends StatefulWidget {
  @override
  _AddIncomeTaxModalState createState() => _AddIncomeTaxModalState();
}

class _AddIncomeTaxModalState extends State<AddIncomeTaxModal> {
  @override
