...
class OutsideMenu extends StatefulWidget {

  bool outsideSceneDone;
  OutsideMenu({this.outsideSceneDone});
  @override
  _OutsideMenuState createState() => _OutsideMenuState(outsideSceneDone: this.outsideSceneDone);
}

class _OutsideMenuState extends State<OutsideMenu> {

  bool outsideSceneDone;
  _OutsideMenuState({this.outsideSceneDone});
                            ...
                            Column(
                              children: [
                                Container(
                                  ...
                                  child: Text("Are you sure you want to go outside?",
                                      style: TextStyle(
                                          shadows: [
                                            Shadow(
                                              offset: Offset(.0, 2.0),
